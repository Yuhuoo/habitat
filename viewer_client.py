...
class HabitatSimInteractiveViewer(Application):
    ...
    def key_press_event(self, event: Application.KeyEvent) -> None:
        ...
        #     self.save_states_to_file(filename, self.states_to_save)
            ...
            new_agent_state.position = np.array([2.5576866, 1.6997461, -2.0614963])
            new_agent_state.rotation = np.quaternion(-0.996879458427429, 0.078456424176693, -0.00869941897690296, -0.000684661790728569)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--scene",
        default="data/versioned_data/mp3d_example_scene_1.1/17DRP5sb8fy/17DRP5sb8fy.glb",
        type=str,
        help='scene/stage file to load (default: "./data/test_assets/scenes/simple_room.glb")',
    )
    parser.add_argument(
        "--dataset",
        default="data/versioned_data/mp3d_example_scene_1.1/mp3d.scene_dataset_config.json",
        type=str,
        metavar="DATASET",
