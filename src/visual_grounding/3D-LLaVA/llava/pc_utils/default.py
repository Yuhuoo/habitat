...
scannet_axis_align_file = "/inspire/hdd/global_user/xieyuan-24039/Dataset/3D-LLaVA-Data/scannet/scannet_axis_align_matrix_trainval.pkl"
...
referseg_transform_train=[
    ...
    dict(
        type="Collect",
        keys=("coord", "grid_coord","normal","superpoint_mask", "gt_masks_3d", "gt_labels_3d", "condition"),
