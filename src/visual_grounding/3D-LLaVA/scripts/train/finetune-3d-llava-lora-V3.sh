...
EXP_NAME=finetune-3d-llava-lora-0705-GMM1CL1COT0-V3-bs-2-gpu8
...
deepspeed llava/train/train_mem.py \
    ...
    --deepspeed /inspire/hdd/global_user/xieyuan-24039/sjm/3D-llava-0705/scripts/zero1_3d_llava.json \
...
bash /inspire/hdd/global_user/xieyuan-24039/sjm/3D-llava-0705/scripts/eval/multigpu_eval_scanrefer-V3.sh